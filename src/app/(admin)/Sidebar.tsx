...
export default function Sidebar({ role, isOpen = false, onClose }: SidebarProps) {
  ...
  return (
    <aside className={`${styles.sidebar} ${isOpen ? styles.sidebarOpen : ""}`}>
      {/* Brand */}
      <Link href="/dashboard" className={styles.sidebarBrand} onClick={handleClick}>
        ...
        {isInstructor ? (
          <>
            ...
            <Link
              ...
              className={`${styles.navItem} ${pathname.includes("/courses") ? styles.active : ""}`}
              onClick={handleClick}
            >
            ...
            {role === "ADMIN" && (
              <Link
                ...
                className={`${styles.navItem} ${pathname.includes("/users") ? styles.active : ""}`}
                onClick={handleClick}
              >
            ...
            <Link
              ...
              className={`${styles.navItem} ${pathname.includes("/marketplace") ? styles.active : ""}`}
              onClick={handleClick}
            >
            ...
            <Link
              ...
              className={`${styles.navItem} ${pathname.includes("/events") ? styles.active : ""}`}
              onClick={handleClick}
            >
      ...
      <div style={{ marginTop: "auto", paddingTop: "1rem", borderTop: "1px solid var(--border-color)" }}>
        <form action={signOutAction}>
          <button
            type="submit"
            className={styles.navItem}
            style={{ width: "100%", background: "transparent", border: "none", cursor: "pointer", textAlign: "left", fontFamily: "inherit", fontSize: "inherit" }}
          >
